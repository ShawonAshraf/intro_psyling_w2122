...
\item Check if extrapolated ratings can be used in predicting psycholinguistic variables
\end{itemize}
\end{frame}
...
\begin{frame}{Experimental Setup}
    \begin{itemize}
        ...
        \item 100 esitmators in the random forest model
    \end{itemize}
\end{frame}
...
\begin{frame}{Results}
\begin{itemize}
    \item For all variable ratingsm kNN is the best performing model
...
\begin{frame}{Results}
\begin{itemize}
    \item However kNN and Random Forest suffer in Affective rating exptrapolation
...
\begin{itemize}
    ...
    \end{itemize}
    \item Authors suspect artefacts in the exptrapolation procedure
\end{itemize}
\end{frame}
...
\begin{frame}{Summary}
    \begin{itemize}
        \item Distributional features can be used to extrapolate psycholonguistic variable ratings
