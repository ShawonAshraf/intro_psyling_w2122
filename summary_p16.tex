...
\title[Summary Presentation : 16]{Extrapolating human judgments from skip-gram vector representations of word meaning (Hollis et al., 2017)} % The short title appears at the bottom of every slide, the full title is only on the title page
